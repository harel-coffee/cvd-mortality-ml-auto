...
plot(lr_cb, main = "LogisticRegression", xlab = "Predicted probability", ylab = "Observed mortality", asp=1, cex.axis=1.25, cex.lab=1.25)
mtext("A", side = 3, adj = 0, line = 1, cex=1.5)
plot(nn_cb, main = "NeuralNetwork", xlab = "Predicted probability", ylab = "Observed mortality", asp=1, cex.axis=1.25, cex.lab=1.25)
mtext("B", side = 3, adj = 0, line = 1, cex=1.5)
plot(rf_cb, main = "RandomForest", xlab = "Predicted probability", ylab = "Observed mortality", asp=1, cex.axis=1.25, cex.lab=1.25)
...
plot(es1_cb, main = "EuroSCORE1", xlab = "Predicted probability", ylab = "Observed mortality", asp=1, cex.axis=1.25, cex.lab=1.25)
mtext("A", side = 3, cex=1.5, adj = 0, line = 1)
plot(es2_cb, main = "EuroSCORE2", xlab = "Predicted probability", ylab = "Observed mortality", asp=1, cex.axis=1.25, cex.lab=1.25)
